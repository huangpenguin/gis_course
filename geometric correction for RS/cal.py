...
if __name__ == '__main__':
    # 由于地方问题，矩阵我就写成一行了
    e = np.array([[1, 3, 1/5, 5], [1/3, 1, 1/3, 3], [5, 3, 1, 9], [1 / 5, 1 / 3, 1/9, 1]])
    a = np.array([[1, 1 / 3, 1 / 5], [3, 1, 1 / 3], [5, 3, 1]])
    b = np.array([[1, 1, 1/3], [1 , 1, 1/3], [3, 3, 1]])
    c = np.array([[1, 1/9, 1/7], [9, 1, 3], [7, 1 / 3, 1]])
    d = np.array([[1, 1/3, 1], [3, 1, 3], [1, 1/3, 1]])
    e = main(e)
    a = main(a)
    b = main(b)
    c = main(c)
